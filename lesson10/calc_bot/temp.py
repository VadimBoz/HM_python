...
#     """Sve input for feature and return to feature selection."""
#     user_data = context.user_data
...
from math_real import mult, div, sum, dif, int_div, int_mod, exponentiation, sqrt, factorial, log10
...
str_num_1 = ''
str_num_2 = ''
# op = {'*':'mult', '/':'div', '+': 'sum', '-':'differens', '//':"int_div", 'div':"int_div", 'mod':"int_mod", 'sqrt':"sqrt", "log10":"log10", 'x!':"fact" , "e^x":"exp"}

op = {'mult':'*', 'div':'/', 'sum':'+', 'differens':'-', "int_div":'//', "int_mod":'mod', 'sqrt':"sqrt", "log10":"log10", "fact":'x!', "exp":"e^x"}
